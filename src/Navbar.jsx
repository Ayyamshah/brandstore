  ...
  return (
    <>
      <nav className="navbar w-100 navbar-expand-lg ">
        ...
        <a className="navbar-brand ms-5" href="#"><img src="/brandstore/images/online-shopping-cart-logo-.avif" alt="" /></a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className='d-flex main me-5' style={{ listStyle: "none" }}>
            ...
            <li className='ms-5 fs-3 '><Link to={'/ProflieButton'} className='text-black' >< CgProfile /></Link></li>
          </ul>
